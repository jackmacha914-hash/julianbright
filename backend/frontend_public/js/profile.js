...
<<<<<<< HEAD
        photoUrl = photoUrl.replace(/^http:\/\/localhost(:\d+)?/, window.API_CONFIG?.BASE_URL || 'https://julianbright.onrender.com');
=======
...
<<<<<<< HEAD
            photoUrl = `${window.API_CONFIG?.BASE_URL || 'https://julianbright.onrender.com'}${data.profile.photo}`;
          } else if (!data.profile.photo.startsWith('http')) {
            photoUrl = `${window.API_CONFIG?.BASE_URL || 'https://julianbright.onrender.com'}/uploads/${data.profile.photo}`;
=======
...
async function changePassword() {
  ...
  try {
<<<<<<< HEAD
    const response = await fetch("https://julianbright.onrender.com/api/profile/change-password", {
=======
